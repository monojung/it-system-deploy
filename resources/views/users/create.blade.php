                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" id="role" class="form-select" required>
                            <option value="user" {{ old('role', 'user') == 'user' ? 'selected' : '' }}>🏥 ผู้ใช้งาน (User - บุคลากรทั่วไปของ รพ.)</option>
                            <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>🛠️ แอดมิน (Admin - เจ้าหน้าที่ IT / ช่างซ่อม / บริหารงานพัสดุ IT)</option>
                            <option value="super_admin" {{ old('role') == 'super_admin' ? 'selected' : '' }}>🛡️ แอดมินระบบ (Super Admin - ผู้ดูแลระบบ IT สูงสุด)</option>
                        </select>
                    </div>
                </div>
