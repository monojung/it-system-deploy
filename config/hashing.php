...
return [
    ...
    */
    ...
    | the amount of time it takes to hash a given password tone.
    |
    */
    ...
    |
    | Here you may specify the configuration options for when passwords are
    | hashed using the Argon algorithm. These will allow you to modify
    | the amount of time and memory it takes to hash a password.
    |
    */
