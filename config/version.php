    ...
    */
    'changelog' => [
        ...
        '2.5.1' => [
            ...
            'badge_color' => '#7c3aed',
            'title' => 'จำกัดสิทธิ์ระบบย้ายครุภัณฑ์: ผู้ใช้งานทั่วไป (User) สามารถแจ้งย้ายจุดติดตั้งได้เฉพาะภายในกลุ่มงาน/แผนกเดิมเท่านั้น',
            'highlights' => [
                'จำกัดการเลือกครุภัณฑ์ต้นทาง (Origin Asset Scope): ในหน้าสร้างคำขอย้ายครุภัณฑ์ ผู้ใช้งานทั่วไปจะค้นหาและเลือกได้เฉพาะครุภัณฑ์ที่สังกัดอยู่ในกลุ่มงาน/แผนกของตนเองเท่านั้น พร้อมแสดง Badge แจ้งเตือนสิทธิ์อย่างชัดเจน',
                'ล็อกหน่วยงานปลายทาง (Destination Department Lock): บังคับให้หน่วยงานปลายทางเป็นกลุ่มงานเดิมของผู้ใช้งานโดยอัตโนมัติ (to_department_id = user->department_id) ไม่สามารถเลือกหรือโอนย้ายไปยังกลุ่มงานอื่นได้',
                'จำกัดประเภทการย้าย (Restricted Transfer Types): ซ่อนตัวเลือก "โอนย้ายหน่วยงาน (Department Transfer)" สำหรับผู้ใช้งานทั่วไป โดยเปิดให้เลือกเฉพาะการย้ายจุดติดตั้ง/ห้องภายในกลุ่มงานเดิม หรือการย้ายใช้งานชั่วคราวเท่านั้น (การโอนย้ายข้ามหน่วยงานสงวนสิทธิ์เฉพาะผู้ดูแลระบบและช่าง IT)',
                'การตรวจสอบความปลอดภัยฝั่ง Backend (Comprehensive Server-side Validation): ตรวจสอบสิทธิ์ใน Controller (store(), update(), edit()) ป้องกันการขอย้ายข้ามกลุ่มงานหรือการแก้ไขคำขอของผู้อื่นอย่างรัดกุม',
                'เพิ่มปุ่มแก้ไขข้อมูลในหน้ารายละเอียดการย้าย: เจ้าของคำขอที่ยังอยู่ระหว่างรอรับเรื่อง (Pending) หรือผู้ดูแลระบบ/ช่าง สามารถกดแก้ไขรายละเอียดจุดติดตั้งใหม่ได้โดยตรงจากหน้าแสดงข้อมูล',
            ],
        ],
        '2.5.0' => [
            'date' => '2026-09-24',
            'badge' => 'Major Feature: 100% Mobile & Tablet Responsive UI/UX Modernization',
            'badge_color' => '#0d9488',
            'title' => 'ปรับปรุงหน้าตาและประสบการณ์การใช้งาน (UI/UX) รองรับสมาร์ทโฟนและแท็บเล็ต 100% สไตล์ Mobile Application',
            'highlights' => [
                'ระบบเลย์เอาต์ตอบสนอง 3 ระดับ (3-Tier Responsive Layout): ออกแบบครอบคลุมทั้งแท็บเล็ต (768px-992px), มือถือมาตรฐาน (<768px) และมือถือหน้าจอเล็ก (<480px) แสดงผลคมชัด ไม่ล้นจอ',
                'เมนูด้านข้างแบบ Off-Canvas Drawer พร้อมระบบสัมผัส (Touch Swipe Gestures): ซ่อนเมนูอัตโนมัติบนมือถือ/แท็บเล็ต มีปุ่มกากบาทปิดเมนู ล็อกการเลื่อนหน้าจอ (Body Scroll Lock) และรองรับการใช้นิ้วปัดซ้ายเพื่อปิด หรือปัดขวาจากขอบจอซ้ายเพื่อเปิดเมนู',
                'แถบเมนูด้านล่าง Frosted Glassmorphism: แถบนำทางด่วนด้านล่าง (Bottom Navigation) พร้อมปุ่มแจ้งซ่อมด่วน ขอยืมอุปกรณ์ ขอข้อมูล และรองรับ Safe-Area Inset ของ iPhone / Android รุ่นใหม่',
                'แปลงกริดหลายคอลัมน์เป็นแนวตั้งอัตโนมัติ 100% (Auto-Stacking Multi-Column Grids): จัดการเลย์เอาต์หน้าจอที่มีการแบ่งคอลัมน์ (เช่น 3fr 2fr, 2fr 1fr, 1fr 1fr) ให้เรียงตัวเป็นแนวตั้งแถวเดียวอย่างสวยงามบนอุปกรณ์พกพาทั่วทั้งระบบ',
                'ป้องกัน iOS Safari Auto-Zoom & Touch Target 44px: ล็อคขนาดฟอนต์ช่องกรอกข้อมูลอย่างน้อย 16px บนมือถือเพื่อป้องกันเบราว์เซอร์ซูมเข้าอัตโนมัติขณะพิมพ์ พร้อมขยายพื้นที่สัมผัสปุ่มและฟอร์มคอนโทรลอย่างน้อย 44px',
                'ฟอร์มแจ้งซ่อมและอัปโหลดรูปภาพบนมือถือ (Mobile-First Form & Dropzone): กดแตะที่กล่องแนบภาพส่วนใดก็ได้เพื่อเรียกเปิดกล้องมือถือถ่ายภาพความเสียหายทันที และปุ่มบันทึก/ส่งข้อมูลแบบเต็มความกว้าง (Full Width)',
                'ปรับปรุงหน้าจอยืนยันตัวตน (Auth Views Responsive): หน้าเข้าสู่ระบบ, ระบุข้อมูลสังกัดแผนกใหม่, และหน้ารอการอนุมัติ รองรับการใช้งานแนวตั้งบนมือถือ 100%',
            ],
        ],
        '2.4.9' => [
            'date' => '2026-09-24',
        ...
        '2.4.8' => [
            ...
            'badge_color' => '#0d9488',
            'title' => 'ระบบยืนยันตัวตนบุคลากรใหม่: บังคับกรอกชื่อ-นามสกุลจริง เลือกกลุ่มงาน/แผนกทันที และต้องรอการตรวจสอบยืนยันตัวตนจากผู้ดูแลระบบก่อนเข้าใช้งาน',
            'highlights' => [
                'ระบบ Onboarding คัดกรองบุคลากรใหม่: ผู้ใช้งานใหม่ที่เข้าสู่ระบบครั้งแรกผ่าน Google SSO, ThaID หรือการลงทะเบียน จะถูกบังคับให้ระบุชื่อจริง นามสกุล และเลือกกลุ่มงาน/ฝ่าย/แผนกที่ตนเองสังกัด เพื่อจำแนกสิทธิและแผนกเข้าสู่ระบบทันที',
                'การตรวจสอบยืนยันตัวตนก่อนเปิดสิทธิ์ (Hospital Staff Verification): บัญชีใหม่จะอยู่ในสถานะ "รอตรวจสอบ (Pending Approval)" และถูกจำกัดสิทธิ์ไม่ให้เข้าถึงข้อมูลภายในของโรงพยาบาล จนกว่าผู้ดูแลระบบ (Admin) จะตรวจสอบกับฐานข้อมูลบุคลากรและกดยืนยันว่าเป็นเจ้าหน้าที่ รพ. จริง',
                'หน้าจอแจ้งเตือนสถานะความปลอดภัย (Pending Approval Screen): แสดงข้อมูลที่ผู้ใช้ยื่นคำขอ แผนกที่เลือก พร้อมคำแนะนำความปลอดภัยและปุ่มตรวจสอบสถานะ',
                'คอนโซลตรวจสอบและอนุมัติสำหรับผู้ดูแลระบบ (/users): เพิ่มการ์ดและแถบกรอง "รอตรวจสอบยืนยันตัวตน", ป้ายสถานะการยืนยัน, พร้อมปุ่ม "อนุมัติ" และ "ปฏิเสธ" (ระบุเหตุผล) ผ่านหน้าเว็บด้วย SweetAlert2',
                'การปกป้องเส้นทางระบบด้วย Middleware EnsureAccountApproved: ควบคุมความปลอดภัยไม่ให้ผู้ใช้งานที่ไม่ผ่านการอนุมัติเข้าถึงส่วนงานต่าง ๆ ของโรงพยาบาลได้',
                'ความต่อเนื่องของระบบเดิม 100%: ผู้ใช้งานเดิมและผู้ดูแลระบบทั้งหมดได้รับการตั้งค่าสถานะเป็น "อนุมัติแล้ว" อัตโนมัติ จึงใช้งานระบบต่อได้อย่างราบรื่นโดยไม่ได้รับผลกระทบ',
            ],
        ],
        '2.4.7' => [
            'date' => '2026-09-23',
